...
# Configuration Script – 0001 - Rev. C

This **Configuration** script is designed for the **0001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – 0001 Rev. C

Este script de **Configuration** está diseñado para el modelo **0001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
